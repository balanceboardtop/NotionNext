...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'porxio', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Toibena', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Toibena-balanceboard', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'balanceboard.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'balanceboard, indo,yoga', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，More Exercise style for Balance board, Focus more on maintaining your balance,welcome to Toibena🎉',
