...
const CONFIG = {
  ...
  STARTER_HERO_BUTTON_1_URL:
    'https://www.amazon.com/dp/B0D9SLV33R', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: 'Get installation instructions', // 英雄区按钮
  STARTER_HERO_BUTTON_2_URL: 'https://drive.google.com/drive/folders/15a_QDrlSw7c44bPgJr_na67UDcNdX1zJ?usp=drive_link', // 英雄区按钮
  STARTER_HERO_BUTTON_2_ICON: '', // 英雄区按钮2的图标，不需要则留空

  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: '', // 产品预览图 ，默认读取public目录下图片
  STARTER_HERO_BANNER_IMAGE: '/images/starter/hero/Z3.jpg', // hero区下方的全宽图
  ...
  STARTER_ABOUT_TITLE: 'A balance trainer that works your core muscles, improves posture, and increases joint flexibility',
  STARTER_ABOUT_TEXT:
  ...
  STARTER_ABOUT_BUTTON_URL: 'https://www.amazon.com/dp/B0GBV2B5P3?th=1',
